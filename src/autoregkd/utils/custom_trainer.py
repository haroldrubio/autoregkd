# Some kind of trainer subclass goes here that allows us to add schedulers, modify the training step to step our probability schedulers, and a way to modify the loss function
# coding=utf-8
...
# Harold: Removed "is_available blocks"
...
class CustomTrainer(Trainer):
    ...
    def create_optimizer_and_scheduler(self, num_training_steps: int):
        ...
        if self.optimizer is None:
            ...
            # Harold: Removed distributed training block
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]]) -> torch.Tensor:
        ...
        # Harold: Removed non-Pytorch integration
        loss.backward()
